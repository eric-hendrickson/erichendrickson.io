        ...
        <HomepageSection id="about-me" heading="About Me" sectionBackgroundColor="bg-green-300">
            <div className="mx-auto flex max-w-screen-2xl flex-col flex-wrap items-start justify-start lg:mx-52">
                <p className="py-4 text-xl">
                    ...
                    or Angular on the front end, but lately I have been doing more development with Python. I am well
                    versed with Linux and Amazon Web Services (AWS) as well.
                </p>
                <p className="py-4 text-xl">
                    ...
                    Javascript framework to play with is Next.js (in fact, I made this page using it). Also, as a way to
                    keep sharp with AWS (particularly CDK), and in order to deploy this website, I created{' '}
                    <a
                ...
                <p className="py-4 text-xl">
                    Feel free to connect with me by using the contact form at the bottom of the page. You can also{' '}
                    <a
                        className="font-bold text-blue-700 underline"
