        ...
        <HomepageSection id="about-me" heading="About Me" sectionBackgroundColor="bg-green-300">
            <div className="mx-auto flex max-w-screen-2xl flex-col flex-wrap items-start justify-start lg:mx-52">
                <p className="py-4 text-xl">
                    My name is Eric Hendrickson. I am a full stack software engineer based out of Las Vegas, Nevada. My
                    general go-to technologies are Spring Boot Java on the back end and either React or Angular on the
                    front end, but I also have a fair amount of experience with Ruby on Rails and NodeJS. I am well
                    versed with Amazon Web Services (AWS) as well.
                </p>
                <p className="py-4 text-xl">
